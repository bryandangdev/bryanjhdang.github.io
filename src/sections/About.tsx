    ...
    <div id="about" className="pt-20 pb-20 border-none">
      <div className="flex flex-col lg:flex-row">
        <div className="sm:mr-20 text-base space-y-4">
          ...
          <p>
            You can get in touch with me through <a className="link" href="https://www.linkedin.com/in/bryanjhdang/" target="_blank">LinkedIn</a> or <a className="link" href="mailto:bda37@sfu.ca">Email</a>.
          </p>
        </div>
